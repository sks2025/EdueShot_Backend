...
import { createQuiz, getAllQuizzes, getQuizById, deleteQuiz, getQuizzesForStudentDashboard, getStudentDashboardQuizzes, startQuiz, submitAnswer, getQuizProgress } from '../controllers/quizController.js';
...
// Student quiz progress routes
router.post("/:quizId/start", authenticateToken, startQuiz); // Start a quiz
router.post("/:quizId/questions/:questionIndex/answer", authenticateToken, submitAnswer); // Submit answer for a question
router.get("/:quizId/progress", authenticateToken, getQuizProgress); // Get quiz progress
